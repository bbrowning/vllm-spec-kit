...
- [ ] Performance impact evaluated and documented
- [ ] Benchmarks planned for performance-sensitive code paths
- [ ] No known regressions without justification

### Hardware Diversity (Principle II)
- [ ] Feature works across supported platforms OR explicitly scoped to specific hardware
- [ ] No breaking changes to existing hardware support
- [ ] Hardware-specific features have appropriate test markers

### Comprehensive Testing (Principle III)
- [ ] Test strategy defined (unit/integration/e2e appropriate for change)
- [ ] Performance-sensitive code includes benchmark tests
- [ ] Appropriate pytest markers planned (`core_model`, `slow_test`, `distributed`, etc.)

### Modular Architecture (Principle IV)
- [ ] Feature fits within existing `/vllm/` and `/tests/` structure
- [ ] New modules justified with architectural reasoning
- [ ] Clear separation of concerns maintained

### Backward Compatibility (Principle V)
- [ ] Public API changes maintain compatibility OR follow deprecation policy
- [ ] Breaking changes documented with migration guide
- [ ] Release notes plan includes compatibility notes
